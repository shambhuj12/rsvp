...
const FileUpload = ({ fileName, currentTheme, handleFileUpload, loadSample, compact = true }) => {
    if (fileName) {
        return (
            <div className="flex items-center gap-3">
                ...
                <Tooltip text="Change File" currentTheme={currentTheme} position='bottom'>
    ...
    return (
        <div className="flex items-center gap-3">
            <Tooltip text="Load Sample Text" currentTheme={currentTheme} position='bottom'>
                <button
                    onClick={loadSample}
            ...
            <Tooltip text="Upload .txt File" currentTheme={currentTheme} position='bottom'>
