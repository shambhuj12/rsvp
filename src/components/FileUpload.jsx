...
const FileUpload = ({ fileName, currentTheme, handleFileUpload, loadSample, compact = true }) => {
    if (fileName) {
        return (
            <div className="flex items-center gap-3">
                ...
                <Tooltip text="Change File" currentTheme={currentTheme}>
    ...
    return (
        <div className="flex items-center gap-3">
            <Tooltip text="Load Sample Text" currentTheme={currentTheme}>
                <button
                    onClick={loadSample}
            ...
            <Tooltip text="Upload .txt File" currentTheme={currentTheme}>
